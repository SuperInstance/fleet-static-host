// =============================================================================
//  quilt.ts — vendored from SuperInstance/quilt-cloudflare
// =============================================================================
//  Source: /home/eileen/projects/quilt-cloudflare/src/worker.ts
//  Upstream commit: 3c293f69967ad507f8b025e158fe697c062d83b0 (2026-08-20)
//  Upstream repo: git@github.com:SuperInstance/quilt-cloudflare.git  (UNTOUCHED)
//
//  fleet-static-host vendors the engine library here instead of importing the
//  package (not published to npm) and instead of modifying the upstream repo.
//  Everything below this header is copied verbatim from upstream, except that
//  upstream's own Worker entry point (`export default { fetch ... }`), MCP
//  handlers, and demo HTML were removed — fleet-static-host has its own entry
//  (src/index.ts). No engine semantics were changed.
//
//  Exports (same as upstream): CellKind, D1Storage, KVCache, VectorizeSearch,
//  CloudflareAI, parseSheet, QuiltEngine + interfaces.
// =============================================================================
